...
class DistIterSampler(Sampler):
    ...
    def __init__(self, dataset, num_replicas=None, rank=None, ratio=100):
        ...
        self.rank = rank
        self.epoch = 0
        self.num_samples = int(math.ceil(len(self.dataset) * ratio / self.num_replicas))  # 200 * 10 / 4 = 500
        self.total_size = self.num_samples * self.num_replicas  # 500 * 4 = 2000
