    ...
    def __getitem__(self, index):
        ...
        for v in HR_frames_list:
            if self.data_type == 'lmdb':
                ...
                img_path = os.path.join(self.HR_root, '..', 'sequences', 'train', name_a, name_b, 'im{}.png'.format(v))             
        ...
        for v in LR_frames_list:
            if self.data_type == 'lmdb':
                ...
                img_path = os.path.join(self.LR_root, '..', 'sequences_LR', 'train', name_a, name_b, 'im{}.png'.format(v))
